...
1. 启动独立执行对话 W1 执行 `orchestration/briefs/T02.md`
2. 等待 `orchestration/reports/T02.md`
3. 验收 T02 的模型、迁移、索引和测试
4. 合并 T02 并推送 GitHub
5. T02 完成后继续派发 T03，再派发 T04/T05
...
- 项目将在新电脑上启动
- 第一轮 T01 已完成
- 当前先单独派发 T02，避免数据库迁移和模型文件冲突
- T02 验收后继续 T03、T04、T05
