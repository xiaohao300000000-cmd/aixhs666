...
1. 主控会话创建 `orchestration/briefs/T01.md`
2. 创建分支 `task/T01-repository-scaffold`
3. 派发 T01 子会话
4. 子会话提交 `orchestration/reports/T01.md`
5. 主控验收并更新本看板
