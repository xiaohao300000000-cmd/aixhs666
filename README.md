...
- 发布态入口：<https://tiho2o4ymck.aiforce.cloud/app/app_17a4790srtt>，当前指定范围可见且要求飞书登录。
...
- 线上已通过专用只读运营网关接入真实 PostgreSQL，妙搭服务端环境变量已配置；当前固定公网入口仍依赖本机和 localtunnel，持续在线云托管属于 `V18-05` 剩余范围。
